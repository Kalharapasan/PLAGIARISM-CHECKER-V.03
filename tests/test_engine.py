...
class TestSimilarityAlgorithms(unittest.TestCase):
    ...
    def test_01_cosine_similarity(self):
        similarity = self.similarity.calculate_cosine_similarity(
    ...
    def test_02_jaccard_similarity(self):
        similarity = self.similarity.calculate_jaccard_similarity(
            self.text1, self.text2
        )
    ...
    def test_05_sequence_similarity(self):
        similarity = self.similarity.calculate_sequence_similarity(
            self.text1, self.text2
        )
